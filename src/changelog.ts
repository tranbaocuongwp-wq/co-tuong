...
export const RELEASES: Release[] = [
  {
    ...
    added: [
      ...
      'Cài đặt hiện tốc độ máy của bạn và thời gian nghĩ tối đa của từng mức khó, kèm nút đo lại.',
    ...
    improved: [
      ...
      'Bàn cờ nằm sát mép trên và to hơn hẳn, rõ nhất là trên điện thoại.',
  ...
  },
  {
    ...
    added: [
      'Quản lý gói tiếng nói ngoại tuyến: thấy đã tải bao nhiêu phần trăm, tạm dừng và tải tiếp khi mạng yếu.',
  ...
  },
  {
    ...
    added: [
      ...
      'Lịch sử ván đấu và xem lại từng nước một.',
